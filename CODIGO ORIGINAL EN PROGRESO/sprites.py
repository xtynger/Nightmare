...
class Player(pg.sprite.Sprite):
	def __init__(self, game, x, y,):
		...
		self.BAR_LENGHT = 450
		self.exp_cap = self.BAR_LENGHT
		self.exp_get = 100

	def load_images(self):

		self.standing_frames = [self.game.spritesheet1.get_image(0, 87, 120, 80),
								self.game.spritesheet1.get_image(0, 175, 120, 88),
								self.game.spritesheet1.get_image(0, 263, 120, 88),
								self.game.spritesheet1.get_image(0, 351, 120, 88),
								self.game.spritesheet1.get_image(0, 526, 120, 88),
								self.game.spritesheet1.get_image(0, 614, 120, 88),
								self.game.spritesheet1.get_image(0, 702, 120, 88),
								self.game.spritesheet1.get_image(0, 789, 120, 88),
								self.game.spritesheet1.get_image(0, 877, 120, 88),
								self.game.spritesheet1.get_image(0, 965, 120, 88),
								self.game.spritesheet1.get_image(0, 1053, 120, 88),
								self.game.spritesheet1.get_image(0, 1140, 120, 88),
								self.game.spritesheet1.get_image(0, 1228, 120, 88),
								self.game.spritesheet1.get_image(0, 1316, 120, 88),
								self.game.spritesheet1.get_image(0, 1404, 120, 88),
								self.game.spritesheet1.get_image(0, 1491, 120, 88),
								self.game.spritesheet1.get_image(0, 1579, 120, 88),
								self.game.spritesheet1.get_image(0, 1667, 120, 88),
								]

		self.walking_frames = [	self.game.spritesheet2.get_image(0, 172, 234, 172),
								self.game.spritesheet2.get_image(0, 344, 234, 172),
								self.game.spritesheet2.get_image(0, 516, 234, 172),
								self.game.spritesheet2.get_image(0, 688, 234, 172),
								self.game.spritesheet2.get_image(0, 860, 234, 172),
								self.game.spritesheet2.get_image(0, 1032, 234, 172),
								self.game.spritesheet2.get_image(0, 1204, 234, 172),
								self.game.spritesheet2.get_image(0, 1376, 234, 172),
								self.game.spritesheet2.get_image(0, 1548, 234, 172),
								self.game.spritesheet2.get_image(0, 1720, 234, 172),
								self.game.spritesheet2.get_image(0, 1892, 234, 172),
								self.game.spritesheet2.get_image(0, 2064, 234, 172),
								self.game.spritesheet2.get_image(0, 2236, 234, 172),
								self.game.spritesheet2.get_image(0, 2408, 234, 172),
								self.game.spritesheet2.get_image(0, 2580, 234, 172),
								self.game.spritesheet2.get_image(0, 2752, 234, 172),
								self.game.spritesheet2.get_image(0, 2924, 234, 172),
								self.game.spritesheet2.get_image(0, 3096, 234, 172),
								self.game.spritesheet2.get_image(0, 3268, 234, 172)
								]
	...
	def get_keys(self):
		...
		if keys[pg.K_4] and WEAPONS['medkit']['ammount'] > 0 and self.health < 100:
	...
	#def checkMouseMovement(self):
		...
		#print(angleDeg)
		# self.image = pg.transform.rotate(self.image, angleDeg)
		#self.image = pg.transform.rotate(self.image, angleDeg)
		#self.rot = pg.mouse.set_pos()
		#self.rot_speed = PLAYER_ROT_SPEED
		#self.rot_speed = -PLAYER_ROT_SPEED
...
##################################################################################################
##################################################################################################	
		#safe = pg.time.get_ticks()
		#if self.armor == 100 and self.damaged:
			#self.armor = 100
		#print(safe)
		#if safe > self.last_shot and not self.damaged and self.armor < 100:
			#self.armor +=  0.5
			#if self.armor > 100:
				#self.armor == 100
		...
		if self.damaged:
			...
			#if self.armor == 100 and self.damaged:
				#self.armor = 100
			#if safe > self.last_shot and self.armor < 100:
				#self.armor +=  0.5
				#if self.armor > 100:
					#self.armor == 100
			#pg.time.set_timer(2, 0)
			try:
...
############################AGREGADO POR MI PARA INCLUIR SALPICADURAS AL DISPARARLES##############################
		...
		if pg.sprite.spritecollideany(self, self.game.bullets):
			...
			#draw_text(("" + str(WEAPONS[self.player.weapon]['damage'])), self.extra_font, 15, WHITE ,(self.pos - vec(32,32)), align="center")
...
###################################################################################################################
		...
		if self.health <= 0:
			...
			self.kill()
			#self.game.draw_damage()

			self.game.player.exp += self.game.player.exp_get
#################################################### INTENTO DE SUMAR EXP AL PLAYER ###################################################
			self.game.player.score += randint(20, 50) #############################################ESTA LINEA AGREGA SCORE AL MATAR MOBS ################
