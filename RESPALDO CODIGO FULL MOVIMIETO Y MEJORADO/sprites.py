...
class Player(pg.sprite.Sprite):
	def __init__(self, game, x, y):
		...
		#self.rot_img = self.standing_frames[self.current_frame]
	...
	def load_images(self):
		self.standing_frames = [self.game.spritesheet_a.get_image(0, 87, 120, 90 ),
								self.game.spritesheet_a.get_image(0, 175.5, 120, 90),
								self.game.spritesheet_a.get_image(0, 263, 120, 90),
								self.game.spritesheet_a.get_image(0, 351, 120, 90),
								self.game.spritesheet_a.get_image(0, 526, 120, 90),
								self.game.spritesheet_a.get_image(0, 614, 120, 90),
								self.game.spritesheet_a.get_image(0, 702, 120, 90),
								self.game.spritesheet_a.get_image(0, 789, 120, 90),
								self.game.spritesheet_a.get_image(0, 877, 120, 90),
								self.game.spritesheet_a.get_image(0, 965, 120, 90),
								self.game.spritesheet_a.get_image(0, 1053, 120, 90),
								self.game.spritesheet_a.get_image(0, 1140, 120, 90),
								self.game.spritesheet_a.get_image(0, 1228, 120, 90),
								self.game.spritesheet_a.get_image(0, 1316, 120, 90),
								self.game.spritesheet_a.get_image(0, 1404, 120, 90),
								self.game.spritesheet_a.get_image(0, 1491, 120, 90),
								self.game.spritesheet_a.get_image(0, 1579, 120, 90),
								self.game.spritesheet_a.get_image(0, 1667, 120, 90),
								]

		self.walking_knife = 	[self.game.spritesheet_b.get_image(0, 87, 118, 87),
								self.game.spritesheet_b.get_image(0, 175, 118, 87),
								self.game.spritesheet_b.get_image(0, 263, 118, 87),
								self.game.spritesheet_b.get_image(0, 351, 118, 87),
								self.game.spritesheet_b.get_image(0, 526, 118, 87),
								self.game.spritesheet_b.get_image(0, 614, 118, 87),
								self.game.spritesheet_b.get_image(0, 702, 118, 87),
								self.game.spritesheet_b.get_image(0, 789, 118, 87),
								self.game.spritesheet_b.get_image(0, 877, 118, 87),
								self.game.spritesheet_b.get_image(0, 965, 118, 87),
								self.game.spritesheet_b.get_image(0, 1053, 118, 87),
								self.game.spritesheet_b.get_image(0, 1140, 118, 87),
								self.game.spritesheet_b.get_image(0, 1228, 118, 87),
								self.game.spritesheet_b.get_image(0, 1316, 118, 87),
								self.game.spritesheet_b.get_image(0, 1404, 118, 87),
								self.game.spritesheet_b.get_image(0, 1491, 118, 87),
								self.game.spritesheet_b.get_image(0, 1579, 118, 87),
								self.game.spritesheet_b.get_image(0, 1667, 118, 87),
								]
		...
		self.shoting_rifle = [self.game.spritesheet_d.get_image(0, 0, 126, 92),
								self.game.spritesheet_d.get_image(0, 92, 126,  117),
								self.game.spritesheet_d.get_image(0, 209, 126, 95),
								]
...
###################################### I D L E S / W A L K I N G S ############################################################################
		...
		if keys[pg.K_SPACE]  and self.weapon == 'knife':
			self.attacking = True
			self.walking = False
			self.idle = False
		else:
